...
const JobModal: React.FC<JobModalProps> = ({ job, onClose, onSave }) => {
  const inputBaseStyles = "w-full px-4 py-2.5 rounded-lg border focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all duration-200 bg-white/50 backdrop-blur-sm";
